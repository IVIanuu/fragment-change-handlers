...
/**
 * A base [FragmentChangeHandler] that facilitates using [android.view.animation.Animation]
 * from xml files s to replace Fragment Views
 */
open class AnimationResChangeHandler : AnimationChangeHandler {
