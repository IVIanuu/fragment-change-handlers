...
abstract class SharedElementTransitionChangeHandler : TransitionChangeHandler() {
    ...
    private fun getToEpicenterView(toSharedElements: MutableMap<String, View>?): View? {
        return if (enterTransition != null && sharedElementNames.isNotEmpty() && toSharedElements != null) {
     ...
     */
    open fun getSharedElementTransition(
        container: ViewGroup,
        from: View?,
        to: View?,
        isPush: Boolean
